        ...
        <footer class="footer-custom text-center text-lg-start mt-5 border-top">
            <div class="container p-4">
                ...
                <div class="text-center py-3">
                    ...
                    class="btn btn-outline-dark rounded-circle social-btn me-2">
                ...
                <small style="display:block; text-align:center;">&copy; {{ date('Y') }} Sua Marca. Todos os direitos reservados.</small>
            </div>
        </footer>
