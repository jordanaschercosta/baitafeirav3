(() => {
  ...
  if (image) {
    document.getElementById("imagem_url").addEventListener("change", function(e) {
      ...
      var ratio = 1;
      if (e.target.dataset.aspectratio !== void 0 && e.target.dataset.aspectratio === "retangular") {
        ratio = 4 / 1;
      }
      reader.onload = function(event) {
        ...
        cropper = new Cropper(image, {
          ...
          autoCropArea: 1,
          crop(event2) {
            document.getElementById("cropX").value = event2.detail.x;
            document.getElementById("cropY").value = event2.detail.y;
            document.getElementById("cropWidth").value = event2.detail.width;
            document.getElementById("cropHeight").value = event2.detail.height;
  ...
  var check = document.getElementById("em_promocao");
  var valorNovo = document.getElementById("valor_novo");
